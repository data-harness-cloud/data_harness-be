...
import supie.common.core.util.IpUtil;
import supie.common.core.util.MyCommonUtil;
import supie.common.log.annotation.IgnoreResponseLog;
import supie.common.log.annotation.OperationLog;
import supie.common.log.config.OperationLogProperties;
import supie.common.log.model.SysOperationLog;
import supie.common.log.model.constant.SysOperationLogType;
import supie.common.log.service.SysOperationLogService;
...
public class OperationLogAspect {
     ...
     * 所有controller方法。
     */
    @Pointcut("execution(public * supie..controller..*(..))")
