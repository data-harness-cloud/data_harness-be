...
import supie.webadmin.app.vo.DevConsoleVo;
import lombok.Data;
...
@TableName(value = "sdt_dev_console")
public class DevConsole extends BaseModel {
    ...
    @Mapper
    public interface DevConsoleModelMapper extends BaseModelMapper<DevConsoleVo, DevConsole> {
    }
    public static final DevConsoleModelMapper INSTANCE = Mappers.getMapper(DevConsoleModelMapper.class);
}
