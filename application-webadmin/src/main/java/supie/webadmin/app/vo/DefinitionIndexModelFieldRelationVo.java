...
/**
 * DefinitionIndexModelFieldRelationVO视图对象。
 *
 * @author rm -rf .bug
 * @date 2020-11-12
 */
@ApiModel("DefinitionIndexModelFieldRelationVO视图对象")
@Data
@EqualsAndHashCode(callSuper = true)
public class DefinitionIndexModelFieldRelationVo extends BaseVo {
