...
/**
 * ModelLogicalMainVO视图对象。
 *
 * @author rm -rf .bug
 * @date 2020-11-12
 */
@ApiModel("ModelLogicalMainVO视图对象")
@Data
@EqualsAndHashCode(callSuper = true)
public class ModelLogicalMainVo extends BaseVo {
    ...
    /**
     * id 的一对一关联数据对象，数据对应类型为ModelPhysicsScriptVo。
     */
    @ApiModelProperty(value = "id 的一对一关联数据对象，数据对应类型为ModelPhysicsScriptVo")
    private Map<String, Object> modelPhysicsScript;
