...
/**
 * 数据规划-数据标准-数据质量表数据操作服务接口。
 *
 * @author rm -rf .bug
 * @date 2020-11-12
 */
public interface StandardQualityService extends IBaseService<StandardQuality, Long> {
     ...
     * @return 返回新增对象。
     */
    StandardQuality saveNew(StandardQuality standardQuality);
     ...
     */
    void saveNewBatch(List<StandardQuality> standardQualityList);
     ...
     */
    boolean update(StandardQuality standardQuality, StandardQuality originalStandardQuality);
     ...
     * @return 查询结果集。
     */
    List<StandardQuality> getStandardQualityList(StandardQuality filter, String orderBy);
     ...
     * @return 查询结果集。
     */
    List<StandardQuality> getStandardQualityListWithRelation(StandardQuality filter, String orderBy);
     ...
     * @return 分组过滤结果集。
     */
    List<StandardQuality> getGroupedStandardQualityListWithRelation(
     ...
     * @return 查询结果集。
     */
    List<StandardQuality> getNotInStandardQualityListByStaidardFieldId(Long staidardFieldId, StandardQuality filter, String orderBy);
