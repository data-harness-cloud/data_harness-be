 ...
 * @date 2020-11-12
 */
public interface StandardQuatityService extends IBaseService<StandardQuatity, Long> {
     ...
     * @return 返回新增对象。
     */
    StandardQuatity saveNew(StandardQuatity standardQuatity);
     ...
     */
    void saveNewBatch(List<StandardQuatity> standardQuatityList);
     ...
     */
    boolean update(StandardQuatity standardQuatity, StandardQuatity originalStandardQuatity);
     ...
     * @return 查询结果集。
     */
    List<StandardQuatity> getStandardQuatityList(StandardQuatity filter, String orderBy);
     ...
     * @return 查询结果集。
     */
    List<StandardQuatity> getStandardQuatityListWithRelation(StandardQuatity filter, String orderBy);
     ...
     * @return 分组过滤结果集。
     */
    List<StandardQuatity> getGroupedStandardQuatityListWithRelation(
     ...
     * @return 查询结果集。
     */
    List<StandardQuatity> getNotInStandardQuatityListByStaidardFieldId(Long staidardFieldId, StandardQuatity filter, String orderBy);
