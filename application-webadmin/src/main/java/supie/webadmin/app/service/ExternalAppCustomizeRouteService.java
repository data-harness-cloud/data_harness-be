...
/**
 * 外部APP与动态路由关联表数据操作服务接口。
 *
 * @author rm -rf .bug
 * @date 2020-11-12
 */
public interface ExternalAppCustomizeRouteService extends IBaseService<ExternalAppCustomizeRoute, Long> {
     ...
     */
    void saveNewBatch(List<ExternalAppCustomizeRoute> externalAppCustomizeRouteList);
     ...
     */
    boolean update(ExternalAppCustomizeRoute externalAppCustomizeRoute, ExternalAppCustomizeRoute originalExternalAppCustomizeRoute);
     ...
     * @return 查询结果集。
     */
    List<ExternalAppCustomizeRoute> getExternalAppCustomizeRouteList(ExternalAppCustomizeRoute filter, String orderBy);
