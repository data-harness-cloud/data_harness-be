...
public interface SysUserService extends IBaseService<SysUser, Long> {
     ...
     * @return 查询结果集。
     */
    List<SysUser> getNotInSysUserListByMemberProjectId(Long memberProjectId, SysUser filter, String orderBy);
     ...
     * @return 查询结果集。
     */
    List<SysUser> getSysUserListByMemberProjectId(Long memberProjectId, SysUser filter, String orderBy);
